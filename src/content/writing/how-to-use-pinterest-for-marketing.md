---
title: "How to use Pinterest for marketing"
date: "2020-12-10"
---
...
While search engines like Google focus on the bottom of the purchase funnel (ie, once someone knows that they have a need and are actively looking for it) and social networks like Facebook and Instagram focus on the top of the funnel (ie, when customers are passively looking to consume content with no intent), Pinterest is one of the few places on the internet that lets marketers reach consumers in the consideration phase.

![Diagram of the purchase funnel from awareness to purchase, with Instagram at the top, Pinterest at the consideration phase, and Google at the bottom](/images/posts/pinterest-consideration.png)

*Where each channel sits in the purchase funnel.*
...
![Google search results for "woodworking ideas for christmas" with the top three results, all from Pinterest, outlined in red](/images/posts/pinterest-results.png)

*Pinterest results filling the first page of Google.*
...
![The Pinterest homefeed showing rows of recommended interests like Christmas drinks, NYE decorations, and appetizer recipes](/images/posts/pinterest-interests.png)

*The homefeed recommends Pins based on the interests Pinterest thinks you have.*
...
![A Pinterest for Business account's boards, including Our Favorite Recipes, The Great Outdoors, and Holiday Gift Guides](/images/posts/pinterest-boards.png)

*Boards on a Pinterest for Business account.*
...
![A recipe Pin with the Save button open, ready to be saved to a Recipes board](/images/posts/pinterest-existing-pin.png)

*Saving an existing Pin to one of your boards.*
...
At Aesthetic, we built software that generated on-brand Pinterest Pins from a company's website automatically. You'd simply enter a URL, and the app would create dozens of variations of graphics to promote that webpage, including several that followed Pinterest's best practices guide. We saw our users cut down the time it took to create a Pin by 95% using our tool.

Once you've created your Pin graphics, you can upload them into the Pinterest system. Add the URL for each Pin along with a detailed description that touches upon what the Pin's about and ideally mentions the specific interests that it's related to. Post these to the right boards, and you're off to the races!

![A grid of on-brand Pins generated for a beef jerky company, each with a consistent layout and call to action](/images/posts/pinterest-aesthetic-pins.png)

*Pins generated automatically with Aesthetic.*

## How to make Pinterest Pins popular?

Once you've uploaded your content to Pinterest, you will see the impressions slowly start to trickle in as the system understands more about what your content's about. Generally speaking it can take months for new content on Pinterest to get enough exposure for Pinterest to determine whether it's interesting enough for it to be promoted more widely within the system.
...
![Four Pinterest ad campaigns, each spending about $35 and earning between 70,000 and 133,000 impressions](/images/posts/pinterest-ads.png)

*Small-budget ad campaigns and their results.*
